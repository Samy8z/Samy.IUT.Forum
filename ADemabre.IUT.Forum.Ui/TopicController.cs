...
namespace ADemabre.IUT.Forum.Ui
{
    public class TopicController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CategorieId,Nom,Description,Cle,Order,Creation,Modification")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CategorieId,Nom,Description,Cle,Order,Creation,Modification")] Topic topic)
        {
            if (id != topic.Id)
            {
                return NotFound();
