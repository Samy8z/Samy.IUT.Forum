...
namespace ADemabre.IUT.Forum.Ui
{
    public class SujetController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TopicId,Name,Suppression,Creation,Modification")] Sujet sujet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,TopicId,Name,Suppression,Creation,Modification")] Sujet sujet)
        {
            if (id != sujet.Id)
            {
                return NotFound();
